...
/// Streaming tool calling example using Groq provider with only llm-kit-provider.
///
...
/// cargo run --example stream_tool_calling -p llm-kit-groq
/// ```
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    println!("🌊 Groq Streaming Tool Calling Example (Provider-Only)\n");
