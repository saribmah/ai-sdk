/// Streaming chat example using Groq provider with only ai-sdk-provider.
///
...
/// cargo run --example stream -p ai-sdk-groq
/// ```
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    println!("🌊 Groq Streaming Chat Example (Provider-Only)\n");
