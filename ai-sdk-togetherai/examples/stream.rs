...
/// Streaming chat example using Together AI provider with only llm-kit-provider.
///
...
/// cargo run --example stream -p llm-kit-togetherai
/// ```
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    println!("🌊 Together AI Streaming Chat Example (Provider-Only)\n");
