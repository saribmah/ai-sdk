/// Tool calling example using Together AI provider with only llm-kit-provider.
///
...
/// cargo run --example chat_tool_calling -p llm-kit-togetherai
/// ```
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    println!("🤖 Together AI Tool Calling Example (Provider-Only)\n");
