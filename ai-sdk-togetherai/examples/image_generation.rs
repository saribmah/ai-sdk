/// Image generation example using Together AI provider with only llm-kit-provider.
///
...
/// cargo run --example image_generation -p llm-kit-togetherai
/// ```
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    println!("🎨 Together AI Image Generation Example (Provider-Only)\n");
