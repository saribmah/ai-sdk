...
/// Configuration options for creating a DeepSeek provider.
#[derive(Debug, Clone)]
pub struct DeepSeekProviderSettings {
    /// Base URL for the API calls (default: `https://api.deepseek.com/v1`)
    pub base_url: String,
...
impl DeepSeekProviderSettings {
    /// Creates a new DeepSeek provider configuration with default settings.
    pub fn new() -> Self {
        Self::default()
    }
...
mod tests {
    ...
    fn test_settings_builder() {
        ...
        assert_eq!(settings.base_url, "https://custom.deepseek.com/v1");
