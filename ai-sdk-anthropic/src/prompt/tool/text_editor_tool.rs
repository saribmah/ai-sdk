...
///
/// ```
/// use ai_sdk_anthropic::tool::text_editor_tool::{AnthropicTextEditorTool, TextEditorToolVersion};
///
...
///
/// ```
/// use ai_sdk_anthropic::tool::text_editor_tool::AnthropicTextEditorTool20250728;
///
