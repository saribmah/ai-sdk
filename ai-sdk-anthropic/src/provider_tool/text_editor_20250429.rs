//! Anthropic text editor tool (version 20250429).
//!
...
//!
//! ```
//! use ai_sdk_anthropic::provider_tool::text_editor_20250429;
//!
...
/// Creates a text editor tool (version 20250429).
///
...
///
/// let tool = text_editor_20250429(Some(
...
/// ));
/// ```
pub fn text_editor_20250429(options: Option<ProviderDefinedToolOptions>) -> Tool {
...
mod tests {
    ...
    #[test]
    fn test_text_editor_20250429_with_description() {
        let tool = text_editor_20250429(Some(
    ...
    #[test]
    fn test_text_editor_20250429_with_approval() {
        let tool = text_editor_20250429(Some(
    ...
    #[test]
    fn test_text_editor_20250429_input_schema() {
        let tool = text_editor_20250429(None);
    ...
    #[test]
    fn test_text_editor_20250429_all_commands() {
        let tool = text_editor_20250429(None);
        let schema = &tool.input_schema;
    ...
    #[test]
    fn test_text_editor_20250429_no_undo_edit() {
        let tool = text_editor_20250429(None);
        let schema = &tool.input_schema;
        let command_enum = schema["properties"]["command"]["enum"].as_array().unwrap();
    ...
    #[test]
    fn test_text_editor_20250429_clone() {
        let tool1 = text_editor_20250429(Some(
    ...
    #[tokio::test]
    async fn test_text_editor_20250429_with_execute() {
        use ai_sdk_provider_utils::{ToolExecuteOptions, ToolExecutionOutput};
        use std::sync::Arc;

        let tool = text_editor_20250429(Some(ProviderDefinedToolOptions::new().with_execute(
            Arc::new(|input, _opts| {
    ...
    #[test]
    fn test_text_editor_20250429_with_args() {
        let tool = text_editor_20250429(Some(
            ProviderDefinedToolOptions::new()
    ...
    #[test]
    fn test_text_editor_20250429_tool_name() {
        let tool = text_editor_20250429(None);
