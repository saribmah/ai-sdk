//! Anthropic text editor tool (version 20250124).
//!
...
//!
//! ```
//! use ai_sdk_anthropic::provider_tool::text_editor_20250124;
//!
...
/// Creates a text editor tool (version 20250124).
///
...
///
/// let tool = text_editor_20250124(Some(
...
/// ));
/// ```
pub fn text_editor_20250124(options: Option<ProviderDefinedToolOptions>) -> Tool {
...
mod tests {
    ...
    #[test]
    fn test_text_editor_20250124_with_description() {
        let tool = text_editor_20250124(Some(
    ...
    #[test]
    fn test_text_editor_20250124_with_approval() {
        let tool = text_editor_20250124(Some(
    ...
    #[test]
    fn test_text_editor_20250124_input_schema() {
        let tool = text_editor_20250124(None);
    ...
    #[test]
    fn test_text_editor_20250124_all_commands() {
        let tool = text_editor_20250124(None);
        let schema = &tool.input_schema;
    ...
    #[test]
    fn test_text_editor_20250124_clone() {
        let tool1 = text_editor_20250124(Some(
    ...
    #[tokio::test]
    async fn test_text_editor_20250124_with_execute() {
        use ai_sdk_provider_utils::{ToolExecuteOptions, ToolExecutionOutput};
        use std::sync::Arc;

        let tool = text_editor_20250124(Some(ProviderDefinedToolOptions::new().with_execute(
            Arc::new(|input, _opts| {
    ...
    #[test]
    fn test_text_editor_20250124_with_args() {
        let tool = text_editor_20250124(Some(
            ProviderDefinedToolOptions::new()
    ...
    #[test]
    fn test_text_editor_20250124_tool_name() {
        let tool = text_editor_20250124(None);
