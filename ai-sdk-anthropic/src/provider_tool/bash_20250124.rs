//! Anthropic bash tool (version 20250124).
//!
...
//! let tool_with_approval = bash_20250124(Some(
...
fn create_bash_20250124_factory() -> ProviderDefinedToolFactory {
...
/// Creates a bash execution tool (version 20250124).
///
...
/// ));
/// ```
pub fn bash_20250124(options: Option<ProviderDefinedToolOptions>) -> Tool {
    let factory = create_bash_20250124_factory();
...
mod tests {
    ...
    fn test_bash_20250124_default() {
        ...
        if let ToolType::ProviderDefined { id, name, args } = &tool.tool_type {
            assert_eq!(id, "anthropic.bash_20250124");
            assert_eq!(name, "bash");
    ...
    #[test]
    fn test_bash_20250124_with_description() {
        let tool = bash_20250124(Some(
    ...
    #[test]
    fn test_bash_20250124_with_approval() {
        let tool = bash_20250124(Some(
    ...
    #[test]
    fn test_bash_20250124_input_schema() {
        let tool = bash_20250124(None);
    ...
    #[test]
    fn test_bash_20250124_factory_reuse() {
        let factory = create_bash_20250124_factory();
    ...
    #[test]
    fn test_bash_20250124_clone() {
        let tool1 = bash_20250124(Some(
    ...
    #[test]
    fn test_bash_20250124_with_args() {
        let tool = bash_20250124(Some(
            ProviderDefinedToolOptions::new()
