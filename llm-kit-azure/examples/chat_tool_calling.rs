/// Tool calling example using Azure OpenAI provider with only llm-kit-provider.
///
...
/// cargo run --example chat_tool_calling -p llm-kit-azure
/// ```
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    println!("🤖 Azure OpenAI Tool Calling Example (Provider-Only)\n");
    ...
    // Create a language model (use your deployment name)
