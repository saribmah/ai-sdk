...
/// Streaming chat example using xAI provider with only llm-kit-provider.
///
...
/// cargo run --example stream -p llm-kit-xai
/// ```
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    println!("🌊 xAI Streaming Chat Example (Provider-Only)\n");
    ...
    println!("💬 User: Write a creative poem about the future of AI.\n");
    println!("🤖 Assistant (streaming): ");
