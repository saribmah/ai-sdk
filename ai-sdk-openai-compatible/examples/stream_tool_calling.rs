/// Streaming tool calling example using OpenAI-compatible provider with only ai-sdk-provider.
///
...
/// cargo run --example stream_tool_calling -p ai-sdk-openai-compatible
/// ```
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    println!("🌊 OpenAI-Compatible Streaming Tool Calling Example (Provider-Only)\n");
