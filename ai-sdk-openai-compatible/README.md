...
OpenAI-compatible provider for [AI SDK Rust](https://github.com/saribmah/ai-sdk) - Universal provider supporting OpenAI, Azure OpenAI, and any OpenAI-compatible API.
