...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    println!("📊 Azure OpenAI Text Embedding Example (Provider-Only)\n");
    ...
    // Create an embedding model (use your deployment name)
    ...
    let texts = vec![
        ...
        "Azure OpenAI offers powerful language models.".to_string(),
    ];
