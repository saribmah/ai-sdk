/// Image generation example using xAI provider with only llm-kit-provider.
///
...
/// cargo run --example image_generation -p llm-kit-xai
/// ```
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    println!("🎨 xAI Image Generation Example (Provider-Only)\n");
