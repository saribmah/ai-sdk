...
/// Streaming tool calling example using OpenAI provider with only llm-kit-provider.
///
...
/// cargo run --example stream_tool_calling -p llm-kit-openai
/// ```
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    println!("🌊 OpenAI Streaming Tool Calling Example (Provider-Only)\n");
