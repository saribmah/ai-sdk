...
Core functionality for [AI SDK Rust](https://github.com/saribmah/ai-sdk) - unified interface for building AI-powered applications with multiple model providers.
