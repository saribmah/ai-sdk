/// Tool calling example using Baseten provider with only llm-kit-provider.
///
...
/// cargo run --example chat_tool_calling -p llm-kit-baseten
/// ```
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    println!("🤖 Baseten Tool Calling Example (Provider-Only)\n");
