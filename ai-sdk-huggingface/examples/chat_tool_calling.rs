/// Tool calling example using Hugging Face provider with only ai-sdk-provider.
///
...
/// cargo run --example chat_tool_calling -p ai-sdk-huggingface
/// ```
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    println!("🤖 Hugging Face Tool Calling Example (Provider-Only)\n");
    ...
    println!("💬 User: What is 157 multiplied by 23?\n");
