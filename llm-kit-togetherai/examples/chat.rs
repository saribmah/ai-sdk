/// Basic chat example using Together AI provider with only llm-kit-provider.
///
...
/// cargo run --example chat -p llm-kit-togetherai
/// ```
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    println!("🤖 Together AI Basic Chat Example (Provider-Only)\n");
